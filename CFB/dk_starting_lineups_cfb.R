...
receiving_summary_2022_week7<- read.csv('receiving_summary_22_7.csv')
receiving_summary_2022_week7$week <- 7
receiving_summary_2022_week7$year <- 2022
...
passing_summary_2022_week7<- read.csv('passing_summary_22_7.csv')
passing_summary_2022_week7$week <- 7
passing_summary_2022_week7$year <- 2022
...
rushing_summary_2022_week7<- read.csv('rushing_summary_22_7.csv')
rushing_summary_2022_week7$week <- 7
rushing_summary_2022_week7$year <- 2022
...
week_games2 <- week_games2[complete.cases(week_games2),]
write.csv(week_games2,"est_p_att_and_r_att_week_8.csv")
