...
write.csv(current_slate_qb1,'dk_qb_proj_10-14-22_main.csv')
...
write.csv(current_slate_rb1,'dk_rb_proj-10-14-22_main.csv')
...
write.csv(current_slate_wr1,'dk_wr_projections_10-14-22_main.csv')
